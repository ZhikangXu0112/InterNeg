...
do
    ...
    do
        for group_num in 1  #1 5 10 50 100 200 300 400 500 1000
        do
                ...
                for extra_text_length in 2000 # 100 500 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000 20000 50000
                    do
                        ...
                        do
                            ...
                            python main.py \
                            --config configs/datasets/imagenet/imagenet_openood_near.yml \
                            ...
                            --mark NearOOD_backbone_${backbone}_text_length${text_length}_seed${seed}_thres${thres}_extra_text_length${extra_text_length}_group_num_${group_num}_random_${random_permute}_official
                        done
                    done
                done
            done
