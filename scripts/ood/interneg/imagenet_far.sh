...
do
    ...
    do
        ...
        do
            for thres in 0.35 # 0 0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5
            do
                for extra_text_length in 2000 # 100 500 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000
                do
                    for text_length in 2000 # 100 500	1000 2000 5000 10000 20000	50000
                    do
                        new_length=$((text_length + 1000))
                        python main.py \
                        --config configs/datasets/imagenet/imagenet_openood_far.yml \
                        ...
                        --mark FarOOD_backbone_${backbone}_text_length${text_length}_seed${seed}_thres${thres}_extra_text_length${extra_text_length}_group_num_${group_num}_random_${random_permute}_official
                    done
                done
            done
        done
