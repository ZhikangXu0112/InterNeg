...
class FixedCLIP(nn.Module):
    def __init__(self, cfg):
        ...
        # self.eurosat_features = get_text_features(self.model, 'eurosat', cfg.backbone.text_prompt)
        # self.dtd_features = get_text_features(self.model, 'dtd', cfg.backbone.text_prompt)
        # self.fgvc_aircraft_features = get_text_features(self.model, 'fgvc_aircraft', cfg.backbone.text_prompt)
        # self.sun_features = get_text_features(self.model, 'sun', cfg.backbone.text_prompt)
        # self.food_features = get_text_features(self.model, 'food101', cfg.backbone.text_prompt)
